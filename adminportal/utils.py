...
def get_aggregated_data(family_member_queryset, family_head_queryset, aggregate_type="dashboard"):
    ...
    if aggregate_type == "dashboard":
        ...
        Questionnaire_queryset = family_member_queryset.filter(Questionnaire__isnull=False)
        ...
        raise ValueError(f"Invalid aggregate_type '{aggregate_type}'. Valid options are 'dashboard', 'export', or 'tab'.")